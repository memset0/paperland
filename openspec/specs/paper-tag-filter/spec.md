# paper-tag-filter Specification

## Purpose
Tag-based filtering of the paper list, including multi-tag AND filtering, URL persistence, clickable tags, and colored badge display.
