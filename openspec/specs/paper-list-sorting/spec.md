...
## Purpose
Adds configurable sort options (created_at, updated_at) with sort order to the paper list API and UI, with localStorage persistence and both date columns always visible.
